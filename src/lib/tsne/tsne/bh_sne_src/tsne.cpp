...
// Perform t-SNE
void TSNE::run(double* X, int N, int D, double* Y, int no_dims, double perplexity, double theta, int maxiter) {
    ...
    float total_time = .0;
    clock_t start, end;
	int max_iter = maxiter, stop_lying_iter = 250, mom_switch_iter = 250;
