...
import numpy as np
import json
from lib import updated_readargs, initrun, results_parser, mds_calc, tsne_calc, jsonconv, plotter
...
def main():
    ...
    names,colors,lines,seqs = initrun.read_fasta(fastafile,args.format,args.color)
